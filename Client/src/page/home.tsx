...
import { ArchiveTaskSchema, CompleteTaskSchema, DeleteTaskSchema } from "@/schemas/task"
            ...
            <Dialog open={ isDialogDelete } onOpenChange={ handleDialogDelete }>
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Are you sure want to delete { taskName }?
                  </DialogDescription>
            ...
            <Dialog open={ isDialogComplete } onOpenChange={ handleDialogComplete }>
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Are you sure want to complete { taskName }?
                  </DialogDescription>
                  <Form { ...formComplete }>
            ...
            <Dialog open={ isDialogArchive } onOpenChange={ handleDialogArchive }>
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Are you sure want to archive { taskName }?
                  </DialogDescription>
                  <Form { ...formArchive }>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="bg-white">
                ...
                <Link
                  to="/save"
                  state={ { taskId: taskId } }
                  className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-slate-100 text-black text-sm font-normal rounded-md ms-[-8px]"
                >
                  Edit Task
                </Link>
                <Button variant="delete" onClick={ handleDialogDelete }> Delete</Button>
